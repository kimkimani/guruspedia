...
status: publish
published: true
url: /how-to-use-bazel-cache-to-improve-bazel-build-times/
...
date: date: 2023-07-25T04:59:07-04:00
topics: [Build]
pick: [top]
excerpt_separator: <!--more-->
images:

  - url: /how-to-use-bazel-cache-to-improve-bazel-build-times/hero.png
    alt: How to Use Bazel Cache to Improve Bazel Build Performance
---
...
And here is an example of how to use the `noremote_cache` on a specific target:
...
It's possible to use Bazel without a cache; however, this may result in slower build times. To use Bazel without a cache, you need to specify the `nocache` flag when running the Bazel commands. Here are a few examples:
