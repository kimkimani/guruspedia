...
[Pinia](https://pinia.vuejs.org/introduction.html) is a lightweight state management library for Vue.js. Pinia aims to provide a type-safe, more intuitive and easy-to-use API. Vuex inspires it. However, a few crucial benefits make Pinia the de facto Vuex 5: These include:
